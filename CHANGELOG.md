...
### Fixed
- Reconnect helpers now remain part of the client and always respect the
  reconnect delay, including clean WebSocket closes.
- Access tokens are renewed before their expected lifetime expires.

### Added
- Separate realtime WebSocket connection callbacks.

## [1.0.1] - 2026-08-17

### Added
- `on_connection` callback on `HomeWizardCloudClient.listen` reporting
  main-stream connect/disconnect state.
